...
public class EnchantmentSkeleton extends Enchantment {
    ...
    public static String toRoman(int num) {
        int level = map.floorKey(num);
        if (num == level) {
            return map.get(num);
        }
        return map.get(level) + toRoman(num - level);
    }
    ...
    public EnchantmentSkeleton(Rarity rarity, EnchantmentTarget enchantmentTarget, EquipmentSlot[] equipmentSlots) {
    ...
    public boolean isAcceptableItem(ItemStack itemStack) {
        return isAcceptible.apply(itemStack);
    }
